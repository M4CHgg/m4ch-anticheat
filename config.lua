Config = {
    ...
    ---- KICK ------
AntiWeaponKick = false, --- if you want it to kick it from the server "true"
AntiWordKick = false,
AntiPedDrop = true,
AntiVehDrop = false,
AntiPropDrop = true,
...
----- log -----
AntiWeaponLog = true, ----- If you want it to keep logs "true"
AntiWordLog = true,
AntiPedLog = false,
AntiVehLog = true,
AntiPropLog = true,
...
------------------------------------------------------------------------------------------
KickMessage = "You have been kicked from the server by M4CH AntiCheat",
-------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
    DiscordWebhook = "https://discord.com/api/webhooks/your-webhook",
    WebhookName = "M4CH", 
    WebhookAvatarUrl = "https://cdn.discordapp.com/attachments/870246085938020421/885491043867451412/image.png",
    ---------------------
